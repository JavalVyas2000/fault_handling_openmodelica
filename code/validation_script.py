...
def power_validation(plant_states):
    ...
    if df['mixer0.sensor_continuous_volumeFlowRate.V_flow'].max() < 0.000105 and df['mixer0.sensor_continuous_volumeFlowRate.V_flow'].max() > 1e-6 and plant_states['init_state']>=3:
