...
def action_validation(plant_states,mixer_plant_states):
    ...
    # if B201_level<=0.034 and B202_level<0.032 and B203_level<0.032 and B204_level<0.023: #### Filling tank B201
    #     init_state = 0
    # elif B201_level>0.032 and B202_level<=0.034 and B203_level<0.032 and B204_level<0.023: #### Filling tank B202
    #     init_state = 1
    # elif B201_level>0.032 and B202_level>0.032 and B203_level<=0.034 and B204_level<0.023: #### Filling tank B203
    #     init_state = 2
    ...
    if mixer_plant_states['init_state'] == 0:
    ...
    elif mixer_plant_states['init_state'] == 1:
    ...
    elif mixer_plant_states['init_state'] == 2:
    ...
    elif mixer_plant_states['init_state'] == 3:
    ...
    elif mixer_plant_states['init_state'] == 4:
    ...
    elif mixer_plant_states['init_state'] == 5:
    ...
    elif mixer_plant_states['init_state'] == 6:
...
def power_validation(plant_states,mixer_plant_states):
    # B201_level=plant_states['B201_level']
    # B202_level=plant_states['B202_level']
    # B203_level=plant_states['B203_level']
    # B204_level=plant_states['B204_level']
    ...
    if df['mixer0.sensor_continuous_volumeFlowRate.V_flow'].max() < 0.000105 and mixer_plant_states['init_state']>=3:
