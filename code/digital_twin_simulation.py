...
def digital_twin(plant_states):
    ...
    setup['ds2']['model']['modules']['mixer0']['init_states']['B204_level']=plant_states['B204_level']
    setup['ds2']['model']['modules']['mixer0']['init_states']['valve_in0_input']=plant_states['valve_in0']
    setup['ds2']['model']['modules']['mixer0']['init_states']['valve_in1_input']=plant_states['valve_in1']
    setup['ds2']['model']['modules']['mixer0']['init_states']['valve_in2_input']=plant_states['valve_in2']
    setup['ds2']['model']['modules']['mixer0']['init_states']['valve_out_input']=plant_states['valve_out']
    setup['ds2']['model']['modules']['mixer0']['init_states']['valve_pump_tank_B201_input']=plant_states['valve_pump_tank_B201']
    ...
    # setup['ds2']['model']['modules']['mixer0']['faults']['anom_clogging']=plant_states['anom_clogging']
    # setup['ds2']['model']['modules']['mixer0']['faults']['anom_valve_in0']=plant_states['anom_valve_in0']
