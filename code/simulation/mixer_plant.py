...
def plant(plant_states):
    with open("simulation/mixer_plant.json") as f:
        setup = json.load(f)
    ...
    setup["ds1"]["model"]["modules"]["mixer0"]["init_states"]["B201_level"] = (
        plant_states["B201_level"]
    )
    setup["ds1"]["model"]["modules"]["mixer0"]["init_states"]["B202_level"] = (
        plant_states["B202_level"]
    )
    setup["ds1"]["model"]["modules"]["mixer0"]["init_states"]["B203_level"] = (
        plant_states["B203_level"]
    )
    setup["ds1"]["model"]["modules"]["mixer0"]["init_states"]["B204_level"] = (
    ...
    setup["ds1"]["model"]["modules"]["mixer0"]["init_states"]["init_state"] = (
        plant_states["init_state"]
    )
    setup["ds1"]["model"]["modules"]["mixer0"]["init_states"]["pump_power"] = (
    ...
    with open("simulation/mixer_plant.json", "w") as f:
